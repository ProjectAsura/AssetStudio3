...
#include "../res/shaders/Compiled/FullScreen_VS.inc"
#include "../res/shaders/Compiled/Copy_PS.inc"
...
{
    Shader result = {};
    result.Size     = sizeof(FullScreen_VS);
    result.pBinary  = FullScreen_VS;
    return result;
}
...
{
    Shader result = {};
    result.Size     = sizeof(Copy_PS);
    result.pBinary  = Copy_PS;
    return result;
}
