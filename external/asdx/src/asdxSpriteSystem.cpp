...
// Constant Values.
//-----------------------------------------------------------------------------
#include "../res/shaders/Compiled/Sprite_VS.inc"
#include "../res/shaders/Compiled/Sprite_PS.inc"
...
bool SpriteSystem::Init(ID3D11Device* pDevice, float w, float h)
{
    ...
    // グラフィックスパイプラインステート生成.
    {
        ...
        desc.VS                 = { Sprite_VS, sizeof(Sprite_VS) };
        desc.PS                 = { Sprite_PS, sizeof(Sprite_PS) };
