...
public:
    ...
    //-------------------------------------------------------------------------
    //! @brief      シェーダリソースビューを破棄します.
    //! 
    //! @param[in]      item        破棄するシェーダリソースビューです.
    //-------------------------------------------------------------------------
    void Dispose(ID3D11ShaderResourceView*& item);

    //-------------------------------------------------------------------------
    //! @brief      アンオーダードアクセスビューを破棄します.
    //! 
    //! @param[in]      item        破棄するアンオーダードアクセスビューです.
    //-------------------------------------------------------------------------
    void Dispose(ID3D11UnorderedAccessView*& item);

    //-------------------------------------------------------------------------
    //! @brief      レンダーターゲットビューを破棄します.
    //! 
    //! @param[in]      item        破棄するレンダーターゲットビューです.
    //-------------------------------------------------------------------------
    void Dispose(ID3D11RenderTargetView*& item);

    //-------------------------------------------------------------------------
    //! @brief      深度ステンシルビューを破棄します.
    //! 
    //! @param[in]      item        破棄する深度ステンシルビューです.
    //-------------------------------------------------------------------------
    void Dispose(ID3D11DepthStencilView*& item);

    //-------------------------------------------------------------------------
    //! @brief      バッファを破棄します.
    //! 
    //! @param[in]      item        破棄するバッファです.
    //-------------------------------------------------------------------------
    void Dispose(ID3D11Buffer*& item);

    //-------------------------------------------------------------------------
    //! @brief      1次元テクスチャを破棄します.
    //! 
    //! @param[in]      item        破棄する1次元テクスチャです.
    //-------------------------------------------------------------------------
    void Dispose(ID3D11Texture1D*& item);

    //-------------------------------------------------------------------------
    //! @brief      2次元テクスチャを破棄します.
    //! 
    //! @param[in]      item        破棄する2次元テクスチャです.
    //-------------------------------------------------------------------------
    void Dispose(ID3D11Texture2D*& item);

    //-------------------------------------------------------------------------
    //! @brief      3次元テクスチャを破棄します.
    //! 
    //! @param[in]      item        破棄する3次元テクスチャです.
    //-------------------------------------------------------------------------
    void Dispose(ID3D11Texture3D*& item);
...
#endif
    asdx::Disposer<ID3D11View>          m_DisposerView;
    asdx::Disposer<ID3D11Resource>      m_DisposerResource;
